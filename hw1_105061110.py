...
class LogisticRegression():
    ...
    def fit(self, predictors, targets):
        ...
        # plt.ylabel('Norm of weight difference')
        # plt.show()
        self.weights = weights
...
def plot_weights(weights):
    ...
    for label, w in weights:
        plt.plot(range(len(w)), np.abs(w), label=label)
    plt.xlabel("Weights")
...
def Problem1():
    ...
    # w.append(("Linear Regression", lr.weights))
    ...
    # w.append(("Linear Regression with Regularization", lr_reg.weights))
    ...
    # w.append(("Linear Regression with Bias", lr_b.weights))
    """
    ...
    w.append(("Linear Regression with Bias and Regularization", lr_b_reg.weights))
    ...
    w.append(("Bayesian Linear Regression", blr.weights))
